...
const Blog = () => {
  ...
  const blogPosts = [
    {
      id: 1,
      title: 'Flow!_OS 22.04 LTS: What\'s New',
    ...
    {
      id: 2,
      title: 'Mastering Window Tiling in Flow!_OS',
    ...
    {
      id: 3,
      title: 'Community Spotlight: Creative Projects Built on Flow!_OS',
    ...
    {
      id: 6,
      title: 'Flow!_OS in Education: Success Stories',
      excerpt: 'How educational institutions are leveraging Flow!_OS for teaching and learning.',
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto mb-8">
            Stay updated with the latest news, tutorials, and insights from the Flow!_OS community.
          </p>
