      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-slate-600 dark:text-slate-300">
                <p>
                  Flow!_OS was born from a simple idea: computers should work for you, not against you. 
                ...
                <p>
                  Today, Flow!_OS powers millions of devices worldwide, from personal laptops to 
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
            ...
            there's a place for you in the Flow!_OS community.
          </p>
